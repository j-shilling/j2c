...
#define J2C_TYPE_CLASS_POOL j2c_constant_pool_get_type ()
#define J2C_TYPE_CLASS_POOL_ITEM j2c_constant_pool_item_get_type ()
...
G_DECLARE_FINAL_TYPE (J2cConstantPool, j2c_constant_pool, J2C, CLASS_POOL, GObject);
G_DECLARE_DERIVABLE_TYPE (J2cConstantPoolItem, j2c_constant_pool_item, J2C, CLASS_POOL_Item, GObject);
